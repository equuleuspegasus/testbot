...
class Playlist {
    ...
    startPhrases = [
        'STARTING IN', 'COMMENCING IN', 'INITIATING IN', 'COUNTDOWN FOR', 'TAKING OFF IN', 'EMBARKING IN', 'COMMENCEMENT IN', 'SWITCHING IT UP IN', 'PREPARING TO START IN',
        'COME ON AND SLAM AND WELCOME TO THE JAM IN', 'ENTERING THE RACE IN', 'ENTERING IN', 'MAKING SOUNDS IN', 'HELL YES IN', 'UNDER WAY IN', 'SIT TIGHT FOR',
        ...
        'YOU HAVE', 'HYPE INTENSIFYING FOR', 'STAND BY FOR', 'WASTING', 'QUEUE FOR', 'KICKING UP DUST IN', 'BEGIN IN', 'THE EXPERIENCE BEGINS IN', 'COUNTING DOWN FOR', 'WAITING FOR',
        ...
        'ANTICIPATION BUILDING FOR', 'WE WILL START IN', 'IT WILL BEGIN IN', 'HOLD ON FOR', 'THE FUN BEGINS IN', 'STOPPING TIME FOR', 'COMMENCING COUNTDOWN:', 'LIFT-OFF IN', 
